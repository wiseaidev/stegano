...
//! ```
//!
//! 2. Use these subcommands to process and manipulate png and jpeg images. Here are some examples:
//!
...
//!    ```
//!
//! 5. Encrypt an inject data in an image:
//!
//!    ```bash
...
//!    ```
//!
//! 6. Decrypt, extract secret from an image and remove the secret from the image:
//!
//!    ```bash
...
//!    ```
//!
//! 8. if wrong key and wrong offset are provided:
//!
//!    ```bash
...
//!    ```
//!
//! 9. if correct key and wrong offset are provided:
//!
//!    ```bash
